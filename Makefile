...
${GRAPHICS_OBJ}: ${GRAPHICS_CXX} ${GRAPHICS_HXX} ${DEBUG_HXX} ${MODELS_HXX}
	${CXX} -c -o $@ $< ${WARNINGS} ${DEFINES} ${OPTIMIZATIONS} ${CXX_STANDARD} ${INCLUDES}

${IO_OBJ}: ${IO_CXX} ${IO_HXX} ${DEBUG_HXX}
	${CXX} -c -o $@ $< ${WARNINGS} ${DEFINES} ${OPTIMIZATIONS} ${CXX_STANDARD} ${INCLUDES}

${MAIN_OBJ}: ${MAIN_CXX} ${DEBUG_HXX} ${GRAPHICS_HXX} ${PARAMETERS_HXX} ${WINDOW_HXX}
	${CXX} -c -o $@ $< ${WARNINGS} ${DEFINES} ${OPTIMIZATIONS} ${CXX_STANDARD} ${INCLUDES}

${MODELS_OBJ}: ${MODELS_CXX} ${MODELS_HXX}
	${CXX} -c -o $@ $< ${WARNINGS} ${DEFINES} ${OPTIMIZATIONS} ${CXX_STANDARD} ${INCLUDES}

${PARAMETERS_OBJ}: ${PARAMETERS_CXX} ${PARAMETERS_HXX} ${DEFAULT_FRAG} ${DEFAULT_VERT} ${IO_HXX}
	${CXX} -c -o $@ $< ${WARNINGS} ${DEFINES} ${OPTIMIZATIONS} ${CXX_STANDARD} ${INCLUDES}

${WINDOW_OBJ}: ${WINDOW_CXX} ${WINDOW_HXX} ${DEBUG_HXX} ${ICON_HXX} ${MODELS_HXX}
	${CXX} -c -o $@ $< ${WARNINGS} ${DEFINES} ${OPTIMIZATIONS} ${CXX_STANDARD} ${INCLUDES}

clean:
	${RM} ${EXECUTABLE_DIRECTORY}/* ${OBJECT_DIRECTORY}/*
